        ...
        >
            ...
            <section className="mt-32 mb-20 w-[80%] xl:w-[65%] flex flex-col items-start justify-center gap-y-8 animate-fade-up duration-600 px-4 lg:px-10">
                ...
                <article className="prose prose-invert max-w-none leading-relaxed mt-8 space-y-6 text-justify">
                    ...
                    <p>
                        ...
                        <a href="mailto:contact.invoicegen@gmail.com" className="text-[#607AFB] hover:underline">
                            contact.invoicegen@gmail.com
                        </a>
                    </p>
                </article>
            ...
            <footer className="w-full xl:w-[80%] flex flex-col items-center gap-8 py-8 border-t border-white/10">
                ...
                <ul className="flex flex-row gap-4">
                    ...
                    >
                        <Twitter className="cursor-pointer opacity-40 hover:text-[#607AFB] transition-colors duration-300" />
                    </li>
                    <li>
                        <Linkedin className="cursor-pointer opacity-40 hover:text-[#607AFB] transition-colors duration-300" />
                    </li>
                    <li>
                        <Facebook className="cursor-pointer opacity-40 hover:text-[#607AFB] transition-colors duration-300" />
                    </li>
                </ul>
