    ...
    content: [
        ...
        columns: [
          {
            ...
            stack: [
              ...
              { text: `No. Facture: ${data.invoiceInfos.details.invoiceNo || ''}`, style: 'label' },
            ]
          },
          {
            width: '50%',
            stack: [
              { text: `À l'ordre de:`, style: 'label', alignment: 'left', bold: true, margin: [0, 0, 20, 0] },
              { text: `${data.clientInfos.clientName || ''}`, style: 'label', alignment: 'left', }
      ...
      // Items Table
      {
        table: {
          ...
          body: [
            [
              { text: 'Article', style: 'tableHeader', fillColor: "#E0E0E0" },
              { text: 'Prix', style: 'tableHeader', alignment: 'center', fillColor: "#E0E0E0" },
              { text: 'Qté', style: 'tableHeader', alignment: 'center', fillColor: "#E0E0E0" },
